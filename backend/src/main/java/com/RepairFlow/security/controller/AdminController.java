...
public class AdminController {
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Map<String, Object>> getStatistiques(@RequestParam(defaultValue = "30") int jours) {
        return ResponseEntity.ok(adminService.getStatistiques(jours));
    }
